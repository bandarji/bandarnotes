...
If you are using either Linux or MacOS make your program executable by adding a 
shebang line and by changing the files permissions (i.e. chmod 755 
exercise1.py).
"""
...
def main():
    ...
    ip_addr2 = '2.2.2.2'
    ip_addr3 = '3.3.3.3'
    print('IPs: {}, {}, {}'.format(ip_addr1, ip_addr2, ip_addr3))
